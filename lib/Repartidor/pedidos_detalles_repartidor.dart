                ...
                Row(
                  ...
                  children: <Widget>[
                    Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: <Widget>[
                        Text(widget.product.foto, style: TextStyle(color: Color(0xff6DA08E), fontSize: 30, fontWeight: FontWeight.bold),),
                        ...
                        Row(
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Icon(Icons.copy, color: Color(0xff6DA08E), size: 25,),
                            ),
                        ...
                        InkWell(
                          ...
                          child: Icon(Icons.location_pin, color: Color(0xff6DA08E), size: 25,),
                        ),
                      ],
                    ),
                  ],
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children:[
                                              Text("\$"+documents["costo"].toString(), textAlign: TextAlign.left,style: TextStyle(color: Color(0xff6DA08E), fontSize: 15, fontWeight: FontWeight.bold)),
