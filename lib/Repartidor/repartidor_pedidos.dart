                                  ...
                                  children: [
                                    Column(
                                      children: [
                                        ...
                                        SizedBox(
                                            width: 120,
                                            child: Text(document["estado3"], textAlign: TextAlign.left, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Color(0xff6DA08E)),)),
                                        SizedBox(
                                          width: 120,
                                          child: Text(document["concepto"], style: TextStyle(color:Color(0xff6DA08E), fontSize: 15.0)),
                                        ),
                                        SizedBox(
                                          width: 120,
                                    ...
                                    Column(
                                      children: [
                                        Text("\$"+document["totalNota"].toString(), style: TextStyle(color:Color(0xff6DA08E))),
                                        SizedBox(height: 10,),
                                        InkWell(
                                          child: SizedBox(
                                            height: 50,
            ...
            children: snapshot.data!.docs.map((document) {
              ...
              return InkWell(
                onTap: () async{
                  ...
                  await Navigator.push(context, MaterialPageRoute(builder: (context) => pedidos_detalles_repartidor(nota_modelo("", document["nombrecliente"],document["folio"],0,document["newid"],document["calle"], 0,document["estado3"],document["latitud"],document["longitud"], document["concepto"], document["nombrecliente"],"g"))),);
