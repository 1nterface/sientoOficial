...
import 'package:siento11/Direccion/catalogo_hombres.dart' as pagos;
import 'package:siento11/Direccion/catalogo_postres.dart' as postres;
import 'package:siento11/Direccion/catalogo_mujeres.dart' as carpinteria;
import 'package:siento11/Direccion/catalogo_hogar.dart' as hogar;
import 'package:siento11/Direccion/catalogo_cipriana.dart' as cipriana;
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: <Widget>[
            Column(
              children:  [
                Tab(icon: Icon(Icons.volunteer_activism, color: Colors.white,)),
                Text("Ropa", style: TextStyle(color: Colors.white),),
              ],
            ),
            Column(
              children:  [
                Tab(icon: Icon(Icons.widgets, color: Colors.white,)),
                Text("Calzado", style: TextStyle(color: Colors.white),),
              ],
            ),
            Column(
              children:  [
                Tab(icon: Icon(Icons.shopping_bag, color: Colors.white,)),
                Text("Acces", style: TextStyle(color: Colors.white),),
              ],
            ),
