...
import 'package:siento11/Direccion/pedidos_detalles.dart';
        ...
        builder: (context, snapshot) {
          ...
          else
          {
            ...
            return Row(
              ...
              children: [
                Icon(Icons.timer),
                Text('Tiempo actual: '+tiempo+" min.", style: TextStyle(color: Color(0xff6DA08E), fontSize: 15.0, fontWeight: FontWeight.bold),),
              ],
            );
  ...
  Widget lista (){
    ...
    return Expanded(
      child: StreamBuilder(
        ...
        //Y ASI  CON TODOS
          stream: reflistaproduccion.where('correoNegocio', isEqualTo: correo).where('categoria', isEqualTo: "Ropa").orderBy('nombreProducto', descending: false).snapshots(),
                ...
                children: snapshot.data!.docs.map((documents) {
                  ...
                  return InkWell(
                    ...
                    onTap: () async{
                      ...
                      await Navigator.push(context, MaterialPageRoute(builder: (context) => producto_detalle2(cajas_modelo("", documents["nombreProducto"],documents["miembrodesde"],documents["folio"],2,3, documents["costoProducto"], documents["existencia"],"7501060327482","", documents["foto"], documents["descripcion"], documents["newid"], documents["costoProducto"]))),);
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                mainAxisAlignment: MainAxisAlignment.end,
                                children: [
                                  Text("\$"+documents["costoProducto"].toString(), style: TextStyle(color: Color(0xff6DA08E), fontSize: 20),),
                                ],
                              ),
                            ],
                          ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        SizedBox(
                                          child: Text("Existencia "+documents["existencia"].toString(), style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16.0, color: Colors.red[900]),),
                                          //height: 30,
                                          width: 160,
                                        ),
                                      ],
