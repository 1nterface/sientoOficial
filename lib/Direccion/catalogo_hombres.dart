import 'package:siento11/Direccion/alta_costos_caja2.dart';
  ...
  Widget lista (){
    ...
    return Expanded(
      child: StreamBuilder(
        ...
        //Y ASI  CON TODOS
          stream: reflistaproduccion.where('correoNegocio', isEqualTo: correo).where('categoria', isEqualTo: "Calzado").orderBy('nombreProducto', descending: false).snapshots(),
