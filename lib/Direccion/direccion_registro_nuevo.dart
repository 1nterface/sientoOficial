...
class direccion_registro_nuevoState extends State<direccion_registro_nuevo> {
  ...
  Future _startUploadTask() async {
    ...
    collRef.set({
      ...
      //'foto': "https://scontent.fcxl1-1.fna.fbcdn.net/v/t39.30808-6/241504064_214116793942601_5341560146217710622_n.jpg?_nc_cat=103&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=HtzO6bW-A2EAX9CjmQ7&_nc_ht=scontent.fcxl1-1.fna&oh=ec2fcbf689567e2995aafa38b270e887&oe=61B1399B",
    });
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Icon(Icons.arrow_forward, color: Color(0xff6DA08E)),
                SizedBox(width: 15),
                //categorias(context),
              ],
            ),
              ...
              children: [
                GestureDetector(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      Icon(Icons.more_time, color: Color(0xff6DA08E)),
                      SizedBox(width: 15),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Icon(Icons.directions_car_rounded, color: Color(0xff6DA08E)),
                Expanded(
                  child: Column(
                    children: text
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Icon(Icons.add_location_sharp, color: Color(0xff6DA08E)),
                Expanded(
                  child: Column(
                    children: text2
                        .map((t) => CheckboxListTile(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Icon(Icons.attach_money, color: Color(0xff6DA08E)),
                Expanded(
                  child: Column(
                    children: textefe
                        .map((t) => CheckboxListTile(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Icon(Icons.credit_card, color: Color(0xff6DA08E)),
                Expanded(
                  child: Column(
                    children: texttar
                        .map((t) => CheckboxListTile(
