...
class alta_postresState extends State<alta_postres> {
  ...
  FirebaseStorage storage = FirebaseStorage.instanceFor(bucket: "gs://siento-11-colectivo.appspot.com");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Alta Accesorios', style: TextStyle(color: Colors.white)),
      ),
      body:
      load == true?
      Center(child: CircularProgressIndicator(color: Color(0xff6DA08E)))
          :
      Padding(
