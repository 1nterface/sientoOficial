...
class carpinteriaState extends State<carpinteria> {
  ...
  listaPedidos(){
    ...
    return Expanded(
      child: StreamBuilder(
          stream: reflistaproduccion.where('id', isEqualTo: "987").where("miembrodesde", isEqualTo: DateFormat("yyyy-MM-dd").format(now)).orderBy('folio', descending: true).snapshots(),
                              ...
                              children: [
                                ...
                                Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    leading: Icon(Icons.add, color: Color(0xff6DA08E)),
                                    title: Text('Alta administrador'),
                                    subtitle: Text('Agrega nuevos administradores al panel de control'),
                                ...
                                Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    leading: Icon(Icons.monetization_on_outlined, color: Color(0xff6DA08E)),
                                ...
                                Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    leading: Icon(Icons.announcement, color: Color(0xff6DA08E)),
