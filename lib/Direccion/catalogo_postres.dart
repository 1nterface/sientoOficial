import 'package:siento11/Direccion/alta_postres.dart';
  ...
  Widget lista (){
    ...
    return Expanded(
      child: StreamBuilder(
        ...
        //Y ASI  CON TODOS
          stream: reflistaproduccion.where('correoNegocio', isEqualTo: correo).where('categoria', isEqualTo: "Accesorios").orderBy('nombreProducto', descending: false).snapshots(),
