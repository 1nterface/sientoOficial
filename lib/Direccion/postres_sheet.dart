...
class _postres_sheetState extends State<postres_sheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
      ...
      //Y ASI  CON TODOS
        stream: reflistacajas.where('correoNegocio', isEqualTo: correoPersonal).where('categoria', isEqualTo: "Accesorios").orderBy('nombreProducto', descending: false).snapshots(),
