                ...
                Row(
                  ...
                  children: [
                    InkWell(
                        ...
                        child: Icon(Icons.edit, color: Color(0xff6DA08E))),
                    InkWell(
                      onTap: (){
                        showDialog(context: context, builder: (BuildContext context) =>  _buildAboutDialog3(context));
                      },
                      child:Text("\$"+widget.product.costoProducto.toString(), style: TextStyle(color: Color(0xff6DA08E), fontWeight: FontWeight.bold, fontSize: 30),),
                    ),
                  ],
                ),
                Row(
                  ...
                  children: [
                    InkWell(
                        onTap: (){
                          showDialog(context: context, builder: (BuildContext context) =>  _buildAboutDialogExis(context));
                        },
                        child: Icon(Icons.edit, color: Color(0xff6DA08E))),
                    InkWell(
                      onTap: (){
                      ...
                      child:Text("Existencia "+widget.product.existencia.toString(), style: TextStyle(color: Color(0xff6DA08E), fontWeight: FontWeight.bold, fontSize: 30),),
                    ),
                  ],
                ),
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(existencia.toString(), style: TextStyle(color: Color(0xff6DA08E), fontSize: 20.0),),
                          ],
                        ),
                      ],
                    ),
