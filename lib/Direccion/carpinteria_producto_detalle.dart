...
import 'package:siento11/Direccion/gerencia_home_sheet.dart';
...
import 'package:siento11/Direccion/producto_detalle2.dart';
import 'package:siento11/Modelo/cajas_modelo2.dart';
                      ...
                      children: [
                        ...
                        Row(
                            ...
                            children:[
                              ...
                              Column(
                                children: [
                                  Text('Para recoger', style: TextStyle(color: Color(0xff6DA08E),fontSize: 35, fontWeight: FontWeight.bold)),
                                  SizedBox(
                                      width: 350,
                                      child: Text(widget.product.nombreProducto, style: TextStyle(color: Color(0xff6DA08E), fontSize: 25), textAlign: TextAlign.center)),
                                ],
                              )
                                  :
                              Column(
                                children: [
                                  Text('Tu pedido', style: TextStyle(color: Color(0xff6DA08E),fontSize: 35, fontWeight: FontWeight.bold)),
                                  Text(widget.product.foto, style: TextStyle(color: Color(0xff6DA08E),fontSize: 20)),
                                ],
                              ),
                        ...
                        Padding(
                          ...
                          child: Text(widget.product.codigoDeBarra, style: TextStyle(fontSize: 25, color: Color(0xff6DA08E))),
                        )
                            :
                        Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Text('Subtotal: ', style: TextStyle(color: Color(0xff6DA08E), fontSize: 20.0),),
                                  subtotal(context),
                                ],
                              ),
                              SizedBox(height:10),
                              Row(
                                ...
                                children: [
                                  Text('Servicio A Dom.: ', style: TextStyle(color: Color(0xff6DA08E), fontSize: 20.0),),
                              ...
                              Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children:[
                                    Text('Total: ', style: TextStyle(color: Color(0xff6DA08E), fontSize: 40.0, fontWeight: FontWeight.bold),),
                                    total(context),
                                  ]
                              ),
                            ],
      ...
      child: Column(
        children: <Widget>[
          AlertDialog(
            ...
            title: Text("Reportar pedido a Siento11 Colectivo", style: TextStyle(color: Colors.black)),
            content: Column(
