...
import 'package:siento11/Direccion/historial_detalle.dart';
...
class historialsucursal extends StatefulWidget {

  cajas_modelo product;
  historialsucursal(this.product);

  @override
  historialsucursalState createState() => historialsucursalState();
}

class historialsucursalState extends State<historialsucursal> {
    ...
    return Expanded(
      child: StreamBuilder(
        //Asi encontraremos los negocios por ciudad y sin problemas con la BD
          stream: reflistaproduccion.where('correoNegocio', isEqualTo: widget.product.nombreProveedor).orderBy('folio', descending: true).snapshots(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Ventas Siento11 Colectivo", style: TextStyle(color: Colors.white)),
      ),
